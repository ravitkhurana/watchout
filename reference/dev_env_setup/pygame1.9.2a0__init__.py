...
# NOTE: I've commented the try/catch for imports and not allowing the modules to be missing
#       This is done because the try/catch confused code-completion of pycharm/pydev(Eclipse)/anaconda(Sublime-text)
